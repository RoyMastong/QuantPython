...
def askForSatisfyCondition(prompt=None):
    text_1 = f"""
...
def giveModelThinkTime(prompt=None):
    text = f"""
    ...
    3 - List each name in the French summary. 4 - Output a json object that contains the following keys: french_summary, num_names.
...
def solveProblemByYourselfFirstly():
    ...
    - Then compare your solution to the student's solution \
     and evaluate if the student's solution is correct or not. Don't decide if the student's solution is correct until \
